<script lang="ts">
	...
	const promptCards = [
		...
		'Which category increased the most recently?',
		'What are my top 3 highest expenses this month?',
		'Am I spending more than last month?',
		'What patterns do you see in my expenses?',
		'How is my profit looking right now?',
		'What is my total revenue vs expenses this month?',
		'Am I currently profitable?',
		'What’s affecting my profit the most?',
		'How has my revenue changed over time?',
		'Which category had the highest expenses?',
		'Are there any categories I should reduce spending in?',
