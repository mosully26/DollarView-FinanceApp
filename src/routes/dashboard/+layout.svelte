...
<div class="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
	<div class="flex min-h-screen">
		<aside
			class="hidden w-64 shrink-0 border-r border-slate-200 bg-white p-5 text-slate-900
			dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100 lg:block"
		>
			<div class="mb-8">
		...
		<div class="flex min-w-0 flex-1 flex-col bg-white dark:bg-slate-950">
			<header
				class="sticky top-0 z-30 border-b border-slate-200 bg-white px-4 py-4 text-slate-900
				dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100 sm:px-6"
			>
			...
			<main
				class="min-h-0 flex-1 bg-white p-4 text-slate-900
				dark:bg-slate-950 dark:text-slate-100 sm:p-6"
			>
				{@render children()}
			</main>
		</div>
